...
const WomenWatch = () => {
  ...
  const [filterWomensWatch, setfilterWomensWatch] = useState([]);
  const [isModalOpen, setIsModalOpen] = useState(false);
  console.log("filterWomensWatch", filterWomensWatch);
  ...
  useEffect(() => {
    const womenWactch = products.filter(
      (product) => product.category === "womens-watches"
    );
    setfilterWomensWatch(womenWactch);
  }, [products]);
  useEffect(() => {
