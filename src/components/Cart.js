    ...
    <div>
      ...
      <div class="container mx-auto xl:p-10 lg:p-12 md:p-10 sm:p-10    ">
        {cartItems.length === 0 ? (
          ...
          <>
            <h1 class="my-4 sm:my-0 sm:mt-0 xl:mb-10 lg:mb-10 md:mb-10 sm:mb-10  text-center  xl:text-2xl lg:text-xl md:text-lg sm:text-lg text-xs font-bold">Shopping Cart</h1>
                    ...
                    <div class="responsive flex justify-between  mb-1 sm:mb-6 border  bg-white xl:p-7 lg:p-7 md:7 sm:p-7 p-5  shadow-md ">
                      ...
                      <div class="ml-4 flex xl:w-[70%] lg:w-[70%] md:w-[70%] sm:w-[66%] w-[100%] sm:justify-between">
                        ...
                        <Link to="/ProductsDetail">
                          <h2 class="text-[12px] xl:text-lg lg:text-base md:text-[14px] sm:text-[13px] font-bold text-gray-900" onClick={()=>openModal(item)}>
                            {item.title}
                          </h2>
                          </Link>
